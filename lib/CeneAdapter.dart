...
class Jogo {
  ...
  String getDescricaoCena() {
    return _cenas[_cenaAtual].tituloCena;
  }

  List<String> getAcoesCena() {
    return _cenas[_cenaAtual].escolha1;
  }

  List<String> getProxima() {
    return _cenas[_cenaAtual].escolha2;
  }
  ...
  void nextCena(int cena) {
    if (cena == 1 && _cenaAtual == 0) {
      _cenaAtual = 2;
    } else if (cena == 2 && _cenaAtual == 0) {
      _cenaAtual = 1;
    } else if (cena == 1 && _cenaAtual == 1) {
      _cenaAtual = 2;
    } else if (cena == 2 && _cenaAtual == 1) {
      _cenaAtual = 3;
    } else if (cena == 1 && _cenaAtual == 2) {
      _cenaAtual = 5;
    } else if (cena == 2 && _cenaAtual == 2) {
      _cenaAtual = 4;
    } else if (_cenaAtual == 3 || _cenaAtual == 4 || _cenaAtual == 5) {
      reiniciaJogo();
    }
  }

  bool buttonShouldBeVisible() {
    if (_cenaAtual == 0 || _cenaAtual == 1 || _cenaAtual == 2) {
      return true;
    } else {
      return false;
    }
